...
function setup_cuda() {
  ...
  pushd ${HOME}/.local/build
  wget https://developer.download.nvidia.com/compute/cuda/12.2.2/local_installers/cuda_12.2.2_535.104.05_linux.run -O cuda_12.2.2_535.104.05_linux.run
...
function setup_cudnn() {
  ...
  pushd ${HOME}/.local/build
  wget https://developer.download.nvidia.com/compute/cudnn/secure/8.9.6/local_installers/12.x/cudnn-linux-x86_64-8.9.6.50_cuda12-archive.tar.xz -O cudnn-linux-x86_64-8.9.6.50_cuda12-archive.tar.xz
...
function setup_tensorrt() {
  ...
  pushd ${HOME}/.local/build
  wget https://developer.download.nvidia.com/compute/machine-learning/tensorrt/secure/8.6.1/tars/TensorRT-8.6.1.6.Linux.x86_64-gnu.cuda-12.2.tar.gz -O TensorRT-8.6.1.6.Linux.x86_64-gnu.cuda-12.2.tar.gz
